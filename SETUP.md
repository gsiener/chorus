...
This guide covers installation and deployment of Chorus. For usage instructions, see [README.md](README.md).
...
To enable tracing, set the `HONEYCOMB_API_KEY` secret. View traces in the [Honeycomb UI](https://ui.honeycomb.io/).
